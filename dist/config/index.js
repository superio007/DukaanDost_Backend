...
export const validateEnv = () => {
    ...
    if (process.env.NODE_ENV === "production" && !process.env.CORS_ORIGIN) {
        console.error("CORS_ORIGIN must be set to a specific origin in production (not wildcard '*')");
        console.error("Please set CORS_ORIGIN in your .env file to your frontend application URL.");
        process.exit(1);
    }
};
/**
