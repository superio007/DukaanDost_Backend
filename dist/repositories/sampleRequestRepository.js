...
export class SampleRequestRepository {
    ...
    async findAll(filters, pagination) {
        try {
            ...
            if (filters.buyerName) {
                ...
                const sanitizedBuyerName = filters.buyerName.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    ...
    async update(id, updateData) {
        try {
            const sampleRequest = await SampleRequest.findByIdAndUpdate(id, updateData, {
...
//# sourceMappingURL=sampleRequestRepository.js.map