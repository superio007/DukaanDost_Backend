...
router.post(
  ...
  createSampleRequestValidator,
  sampleRequestController.create.bind(sampleRequestController),
);
...
router.get(
  "/:id",
  authenticate,
  sampleRequestController.findById.bind(sampleRequestController),
);
...
router.delete(
  ...
  authenticate,
  authorize(Role.ADMIN),
  sampleRequestController.delete.bind(sampleRequestController),
);
 ...
 */
router.patch(
  "/:requestId/items/:itemId/status",
  authenticate,
  authorize(Role.SAMPLING_HEAD, Role.ADMIN),
  updateItemStatusValidator,
  sampleRequestController.updateItemStatus.bind(sampleRequestController),
);
